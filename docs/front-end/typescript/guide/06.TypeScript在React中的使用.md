...
#### 2.2.6. compilerOptions.allowSyntheticDefaultImports
...
#### 2.2.8. compilerOptions.forceConsistentCasingInFileNames
...
#### 2.2.9. compilerOptions.noFallthroughCasesInSwitch
