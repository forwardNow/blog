...
### 10.3. Config order of precedence
...
## 15. Using `application/x-www-form-urlencoded` format

### 15.1. URLSearchParams
...
### 15.2. Query string (Older browsers)
...
### 15.4. 🆕 Automatic serialization to URLSearchParams
...
## 16. Using `multipart/form-data` format
...
### 16.2. 🆕 Automatic serialization to FormData
