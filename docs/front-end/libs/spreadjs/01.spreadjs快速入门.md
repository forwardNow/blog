...
@modify date 2024-04-18 14:32:40
@desc [description]
#endregion-->
...
export default defineComponent({
  ...
  methods: {
    ...
    handleDesignerInitialized(designer) {
      ...
      const [spreadSelection] = sheet.getSelections();

      // 将区域转化为公式
      const excelCoordinate = GC.Spread.Sheets.CalcEngine.rangeToFormula(spreadSelection);

      console.log(spreadSelection, excelCoordinate);
