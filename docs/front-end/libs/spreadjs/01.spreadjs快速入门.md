...
@modify date 2024-05-21 13:41:09
@desc [description]
#endregion-->
...
spread.contextMenu.onOpenMenu = function (
   ...
   let locked = sheet.getCell(hitInfo.worksheetHitInfo.row, hitInfo.worksheetHitInfo.col).locked();
   itemsDataForShown.forEach(element => {
      if (element.command === "richText" && !locked) {
