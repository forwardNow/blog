...
@modify date 2024-07-26 15:11:12
@desc [description]
#endregion-->
...
2. 设置语言
    ...
    export default {
      methods: {
        async onDesignerInit(designer: IGC.Spread.Sheets.Designer.Designer) { 
          (GC.Spread.Sheets as any).Designer.setResources(designerEn);
