...
@modify date 2024-04-16 16:24:07
@desc [description]
#endregion-->
  ...
  methods: {
    getConfig() {
      this.config.commandMap = {
        ...
        RemoveESignatures: {
          text: 'Remove E-Signature',
          iconClass: 'lw-ribbon-icon-remove-e-signatures',
          commandName: 'RemoveESignatures',
          execute() {
            console.log('RemoveESignatures');
          },
        },

        ViewCellChanges: {
          iconClass: 'lw-ribbon-icon-view-cell-changes',
          text: 'View Cell Changes',
          commandName: 'ViewCellChanges',
          execute() {
            console.log('ViewCellChanges');
          },
        },
        ViewAuditTrail: {
          iconClass: 'lw-ribbon-icon-view-audit-trail',
          text: 'View Audit Trail',
          commandName: 'ViewAuditTrail',
          execute() {
            console.log('ViewAuditTrail');
          },
        },
        AuditTrailReports: {
          iconClass: 'lw-ribbon-icon-audit-trail-reports',
          text: 'Audit Trail Reports',
          commandName: 'AuditTrailReports',
          execute() {
            console.log('AuditTrailReports');
          },
        },
        CellRevisionHistory: {
          iconClass: 'lw-ribbon-icon-cell-revision-history',
          text: 'Cell Revision History',
          commandName: 'CellRevisionHistory',
          execute() {
            console.log('CellRevisionHistory');
          },
        },
        ColorConfiguration: {
          iconClass: 'lw-ribbon-icon-color-configuration',
          text: 'Color Configuration',
          commandName: 'ColorConfiguration',
          execute() {
