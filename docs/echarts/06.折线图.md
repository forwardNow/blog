...
<<< @/codes/charts/11-line-basic.html
...
| -   | option                  | 说明              |
|-----|-------------------------|-----------------|
| 标注  | `series-line.markPoint` | `max` `min`     |
| 标线  | `series-line.markLine`  | `average`       |
| 标区域 | `series-line.markArea`  | 常用于标记图表中某个范围的数据 |
...
<<< @/codes/charts/12-line-mark.html
...
| -   | option                  | 说明               |
|-----|-------------------------|------------------|
| 平滑  | `series-line.smooth`    | 是否平滑曲线显示。        |
| 样式  | `series-line.lineStyle` | `color` , `type` |
...
<<< @/codes/charts/13-line-style.html

### 2.3. 填充

说明： 区域填充样式，设置后显示成区域面积图。

配置： `series-line.areaStyle`
...
<<< @/codes/charts/14-line-area.html
...
<<< @/codes/charts/15-line-boundaryGap.html
...
<<< @/codes/charts/16-line-scale.html
...
<<< @/codes/charts/17-line-stack.html
