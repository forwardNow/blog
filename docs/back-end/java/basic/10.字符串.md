...
![基本内存模型](./images/10/02.png)

字符串直接量存储在 串池（StringTable）中：

![串池（StringTable）](./images/10/03.png)

通过字符串直接量创建的 String 对象，如果其内容一样，则地址一样：
...
![通过 `new` 创建的 String 对象](./images/10/06.png)
