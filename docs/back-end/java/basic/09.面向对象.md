...
![1](./images/09/images/1.png)

成员方法调用过程：

![2](./images/09/images/2.png)

### 多个对象内存图

成员变量使用过程：

![3](./images/09/images/3.png)

成员方法调用过程：

![4](./images/09/images/4.png)
...
定义标准的学生类，要求name和age使用private修饰，并提供set和get方法以及便于显示数据的show方法，
...
作用： 创建对象，如 `Student stu = new Student();`
