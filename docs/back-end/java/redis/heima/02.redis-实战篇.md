...
@modify date 2025-11-15 11:04:09
@desc [description]
#endregion-->
...
![image-20251112220043999](./images/image-20251112220043999.png)
...
不过要注意的是，当队列中没有消息时 RPOP 或 LPOP 都会返回 null，并不像 JVM 的阻塞队列那样会阻塞并等待消息。
因此应该使用 BRPOP/BLPOP 来实现阻塞效果
...
* `SUBSCRIBE channel [channel]`: 订阅 1个或多个 频道
...
![image-20251115100552576](./images/image-20251115100552576.png)

![image-20251115101208207](./images/image-20251115101208207.png)

![image-20251115101346032](./images/image-20251115101346032.png)
