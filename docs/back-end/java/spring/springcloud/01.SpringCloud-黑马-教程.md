...
@modify date 2026-02-20 11:52:56
@desc [description]
#endregion-->
...
将 elasticsearch-analysis-ik-7.12.1.zip 解压并重命名为 ik

将 ik 目录上传到 /var/lib/docker/volumes/es-plugins/_data
