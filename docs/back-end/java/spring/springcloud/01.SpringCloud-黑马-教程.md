...
@modify date 2026-02-17 11:45:31
@desc [description]
#endregion-->
...
### 10.1.2. 初识 Docker - Docker 和虚拟机的差别
...
{
  "registry-mirrors": ["https://fk1siu3e.mirror.aliyuncs.com"]
}
EOF
