...
@modify date 2026-01-14 19:44:42
@desc [description]
#endregion-->
...
### 17.2. bean 加载方式 2 - XML+注解 定义 bean
...
### 17.3. bean 加载方式 3 - 配置类+注解 定义 bean
...
### 17.8. bean 加载方式 5 - ctx 动态注册 bean
...
### 17.9. bean 加载方式 6 - @Import 导入 ImportSelector 
...
### 17.10. bean 加载方式 7 - @Import 导入 ImportBeanDefinitionRegistrar 
...
### 17.11. bean 加载方式 8 - @Import 导入 BeanDefinitionRegistryPostProcessor 
