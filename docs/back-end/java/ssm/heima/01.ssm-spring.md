...
@modify date 2025-07-24 23:31:09
@desc [description]
#endregion-->
...
* Spring 的事务只会对 `Error` 和 `RuntimeException` 及其子类进行事务回滚，也就是说编译期异常默认不回滚
* 此属性可以设置 非 `Error` 和 `RuntimeException` 的异常也可以回滚
...
![image-20250724231915857](./images/image-20250724231915857.png)
...
![image-20250724232111773](./images/image-20250724232111773.png)
